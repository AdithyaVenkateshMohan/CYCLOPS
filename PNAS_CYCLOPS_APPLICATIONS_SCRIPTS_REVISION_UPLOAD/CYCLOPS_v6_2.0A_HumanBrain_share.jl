...
############################################################
homologuedir=string(current_dir,"\\SeedGenes\\")
cd(homologuedir)
print(homologuedir)
# using PyPlot
seed_homologues1=readdlm("Human_UbiquityCyclers.csv", ',')

print(size(seed_homologues1), seed_homologues1)
...
print("fullnonseed_data", size(fullnonseed_data))
...
print("estimated_magnitudes1" , estimated_magnitudes1 , "estimated_phaselist1", estimated_phaselist1 , "bestnet1" , bestnet1)
# ###################################
