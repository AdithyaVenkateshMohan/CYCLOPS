...
mutable struct BottleNeck_Layer
    z::Array{Float64,1}           # pre activation value
...
######################################################################
mutable struct Layer_Connections
...
######################################################################
mutable struct UnbalancedNeuralNetwork
    indim::Integer
    outdim::Integer
    nbottle::Integer
    ncirc::Integer
...
######################################################################
mutable struct Delta #following Michael Nielson text delta=dCost/dz
